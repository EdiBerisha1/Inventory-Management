...
export namespace Prisma {
  ...
  */
  ...
  export type SalesSummaryOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"saleSUmmaryId" | "totalValue" | "changePercentage" | "date", ExtArgs["result"]["salesSummary"]>
  ...
  export interface SalesSummaryDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `saleSUmmaryId`
     * const salesSummaryWithSaleSUmmaryIdOnly = await prisma.salesSummary.findMany({ select: { saleSUmmaryId: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many SalesSummaries and only return the `saleSUmmaryId`
     * const salesSummaryWithSaleSUmmaryIdOnly = await prisma.salesSummary.createManyAndReturn({
     *   select: { saleSUmmaryId: true },
     *   data: [
     *     // ... provide data here
     *   ]
     * })
     ...
     * })
     * 
     * // Update zero or more SalesSummaries and only return the `saleSUmmaryId`
     * const salesSummaryWithSaleSUmmaryIdOnly = await prisma.salesSummary.updateManyAndReturn({
     *   select: { saleSUmmaryId: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface SalesSummaryFieldRefs {
    readonly saleSUmmaryId: FieldRef<"SalesSummary", 'String'>
  ...
  export type SalesSummaryWhereInput = {
    ...
    saleSUmmaryId?: StringFilter<"SalesSummary"> | string
  ...
  export type SalesSummaryScalarWhereWithAggregatesInput = {
    ...
    saleSUmmaryId?: StringWithAggregatesFilter<"SalesSummary"> | string
  ...
  export type SalesSummaryUpdateInput = {
    saleSUmmaryId?: StringFieldUpdateOperationsInput | string
